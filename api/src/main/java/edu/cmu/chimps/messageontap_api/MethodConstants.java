...
public class MethodConstants {
    ...
    /**
     * methods of internal tasks
     */
    public static final String INTERNAL_METHOD_NEW_SESSION = "session_new";
    public static final String INTERNAL_METHOD_END_SESSION = "session_end";
    public static final String INTERNAL_METHOD_STATUS_QUERY = "status_query";
    public static final String INTERNAL_METHOD_STATUS_REPLY = "status_reply";
    public static final String INTERNAL_METHOD_RESPONSE_REFETCH = "response_refetch";
